...
define('CLI_LOCAL_ARCHIVE_DIR', '.build-archives');
define('CLI_LOCAL_BUILD_DIR', 'builds');
define('CLI_LOCAL_PROJECT_CONFIG', '.platform-project');
define('CLI_LOCAL_REPOSITORY_DIR', 'repository');
define('CLI_LOCAL_SHARED_DIR', 'shared');
