...
class SelfReleaseCommand extends CommandBase
{
    ...
    protected static $defaultDescription = 'Build and release a new version';
    ...
    protected function configure()
    {
        ...
        $this->addArgument('version', InputArgument::OPTIONAL, 'The new version number')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $validateNewVersion = function (?string $next) use ($lastVersion, $allowLower): string {
            if ($next === null) {
