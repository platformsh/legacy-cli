...
class UserAddCommand extends CommandBase
{
     ...
     * @return string
     */
    private function getUserLabel(ProjectAccess $access): string
    {
        $account = $this->api->getAccount($access);
     ...
     * @return string
     */
    private function showProjectRoleForm(string $defaultRole, InputInterface $input): string
    {
     ...
     */
    private function getSpecifiedTypeRoles(array &$roles, array $environmentTypes, bool $ignoreErrors = true): array
    {
        $typeRoles = [];
